...
4. Submit a link to the deployed contract on the Goerli testnetwork. To do this use the metamask EVM on remix instead of teh default. Also make sure you have ETH from the goerli faucet. Befofe you deploy check that you currently using the goerli testnest in your metamask.